...
OPTIONS = {
    'py2app': {
        ...
        'excludes': [
            ...
            'pkginfo',
            'project_lib',
            'project_lib.ClOptions',
            'project_lib.METATYPES_JSON_SUFFIX',
            'project_lib.MOD_CMD',
            'project_lib.NewProjectTypes',
            'project_lib.QMLDIR_FILE',
            'project_lib.QmlProjectData',
            'project_lib.SHADER_SUFFIXES',
            'project_lib.TRANSLATION_SUFFIX',
            'project_lib.check_qml_decorators',
            'project_lib.is_python_file',
            'project_lib.migrate_pyproject',
            'project_lib.new_project',
            'project_lib.remove_path',
            'project_lib.requires_rebuild',
            'project_lib.run_command',
            'pytest',
            'qtpy2cpp_lib',
            'qtpy2cpp_lib.visitor',
            'tqdm',
        ],
